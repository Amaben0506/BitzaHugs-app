...
const TEMPLATES = [
  {
    ...
    emoji: "🌅",
    desc: "A gentle start to the day",
    color: "#FFF0DF",
    accent: "#D99A3D",
    items: [
  ...
  },
  {
    ...
    name: "After School",
    emoji: "🏠",
    desc: "Wind down after a busy day",
    color: "#E7F4FF",
    accent: "#4C9ED9",
    items: [
  ...
  },
  {
    ...
    name: "Weekend Calm",
    emoji: "☀️",
    desc: "A relaxed weekend structure",
    color: "#EEF7E8",
    accent: "#78A866",
    items: [
...
const defaultRoutine = [
  ...
  },
  {
    ...
    time: "2:00 PM",
    icon: "support-fidget-spinner.png",
    completed: false,
    category: "break",
  },
];
...
export default function RoutineScreen({ navigation }) {
  ...
  const saveRoutine = async (updated) => {
    try {
      ...
      const allDone =
        updated.length > 0 && updated.every((item) => item.completed);

      if (allDone) {
        const today = new Date().toDateString();
        const lastComplete = await AsyncStorage.getItem(
          "bitzaRoutineLastCompleteDay"
        );
  ...
  const deleteActivity = (id) => {
    const updated = routineItems.filter((item) => item.id !== id);
    saveRoutine(updated);
  };
      ...
      >
        ...
        <View style={styles.topRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            onPress={() =>
              navigation.getParent()?.navigate("ChildProfile") ??
        ...
        <View style={styles.noteCard}>
          ...
          <View style={styles.noteTextWrap}>
            ...
            <Text style={styles.noteText}>
              Routines can bend. Missing a step doesn't ruin the day.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.listHeader}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity onPress={resetToday} activeOpacity={0.85}>
              <Text style={styles.resetText}>Reset</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={resetToDefault} activeOpacity={0.85}>
        ...
        <View style={styles.routineListCard}>
          {routineItems.length === 0 ? (
            <View style={styles.emptyCard}>
              <Image
                source={require("../assets/icons/tool-checklist-pencil.png")}
                style={styles.emptyIcon}
                resizeMode="contain"
              />
              <Text style={styles.emptyTitle}>No activities yet</Text>
              <Text style={styles.emptyText}>
                Add your first routine step below.
              </Text>
            </View>
          ) : (
                ...
                <View style={styles.routineRow}>
                  ...
                  <View style={styles.routineTextWrap}>
                    <Text
                      style={[
                        styles.routineTitle,
                        item.completed && styles.routineTitleDone,
                      ]}
                    >
                      {item.title}
                    </Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
          onPress={() => navigation.getParent()?.navigate("AddRoutineActivity")}
        >
          ...
          <View style={styles.addTextWrap}>
            ...
            <Text style={styles.addSubtitle}>
              Meals, breaks, school tasks, bedtime & more.
            </Text>
          </View>
        ...
        <View style={tmpl.overlay}>
          <View style={tmpl.sheet}>
            ...
            <View style={tmpl.header}>
              ...
              <Text style={tmpl.subtitle}>
                Choose a starting point — you can edit it after.
              </Text>
            ...
            <ScrollView
              style={tmpl.scroll}
              contentContainerStyle={tmpl.scrollContent}
              showsVerticalScrollIndicator={false}
            >
              {TEMPLATES.map((template) => (
                <TouchableOpacity
                  ...
                  style={[
                    tmpl.templateCard,
                    {
                      ...
                      borderColor: template.accent + "44",
                    },
                  ]}
                ...
                >
                  ...
                  <View style={tmpl.templateTextWrap}>
                    <Text style={[tmpl.templateName, { color: template.accent }]}>
                      {template.name}
                    </Text>
                    <Text style={tmpl.templateDesc}>{template.desc}</Text>
                    <Text style={tmpl.templateCount}>
              ...
              <View style={tmpl.noteCard}>
                ...
                <Text style={tmpl.noteText}>
                  Applying a template will replace your current routine. Your
                  progress will reset.
                </Text>
              </View>
            </ScrollView>
...
const styles = StyleSheet.create({
  ...
  progressCircleCard: {
    width: 64,
    backgroundColor: "rgba(246,236,255,0.95)",
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "#E3D2F8",
    alignItems: "center",
  ...
  progressTrack: {
    height: 7,
    borderRadius: 7,
    backgroundColor: "rgba(237,227,251,0.95)",
    overflow: "hidden",
    marginBottom: 4,
  },
  ...
  noteCard: {
    backgroundColor: "rgba(255,232,220,0.95)",
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "#FFD0C0",
    paddingHorizontal: 11,
