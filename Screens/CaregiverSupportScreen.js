...
const supportOptions = [
  {
    ...
    description: "Encouraging nudges for hard or busy days.",
  ...
  },
  {
    ...
    description: "Simple moments to pause and notice how you feel.",
    icon: "heart-outline",
    color: "#EF6F8D",
    bg: "#FFE8EF",
    enabled: true,
  },
  {
    ...
    description: "Quick reset ideas when things feel overwhelming.",
    icon: "leaf-outline",
    color: "#7FA66A",
    bg: "#EEF5E9",
    enabled: true,
  },
  {
    ...
    description: "Guided breathing and grounding reminders.",
    icon: "water-outline",
    color: "#6B9EDB",
    bg: "#EAF4FF",
    enabled: false,
  },
  {
    ...
    description: "Gentle prompts to process the day.",
    icon: "pencil-outline",
    color: "#8C55F6",
    bg: "#F3EAFE",
    enabled: false,
...
export default function CaregiverSupportScreen({ navigation }) {
  ...
  const saveCaregiverSupports = async () => {
    const selected = getSelectedSupports();

    try {
      await AsyncStorage.setItem(
        CAREGIVER_SUPPORT_KEY,
      ...
      Alert.alert(
        "Oops",
        "Something went wrong saving your caregiver supports."
      );
    }
  };
  ...
  const handleSkip = async () => {
    try {
      await AsyncStorage.setItem(CAREGIVER_SUPPORT_KEY, JSON.stringify([]));
      navigation.navigate("CalmSpaceReady");
    } catch (error) {
      console.log("Error skipping caregiver supports:", error);
      navigation.navigate("CalmSpaceReady");
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Choose the support that would feel helpful for you as a caregiver.
        </Text>
        ...
        <View style={styles.introCard}>
          ...
          <Text style={styles.introText}>
            BitzaHugs is here for your child, but it’s also here to support you
        ...
        <View style={styles.noteCard}>
          ...
          <Text style={styles.noteText}>
            You can change these anytime. Support for you matters too.
          </Text>
        </View>
        ...
        <View style={styles.comingSoonCard}>
          ...
          <View style={styles.comingSoonTextWrap}>
            <Text style={styles.comingSoonTitle}>Reminder preferences</Text>
            <Text style={styles.comingSoonText}>
              These choices help personalize caregiver support. Push
              notifications can be added later when reminders are turned on.
            </Text>
          </View>
        </View>
